...
class BaiduInterviewViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    
    var tableView:UITableView? = nil
    let cellIdentifier="interviewsTBCell"
    let data=[
        ["title":"响应链（uiimageview的user interfaced ＝ no ，uibutton添加在其上是否可以点击响应:否）","class":"BDResponderChainViewController"],
        ["title":"ali","class":"NSIPViewController"]
    ]
    ...
    override func viewDidLoad() {
        ...
        self.title="Interviews question summarize"
